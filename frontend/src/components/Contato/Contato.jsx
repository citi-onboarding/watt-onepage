                  ...
                  <div className="contato-box">
                    ...
                    <div id="id-mensagem" className="coluna">
                      <label id="mensagem" htmlFor="mensagem" aria-label="Como podemos te ajudar" >
                        <textarea id="mensagem" required name="mensagem" aria-labelledby="mensagem" placeholder="Como podemos te ajudar?" state-type="mensagem" cols="50" rows="6" onChange={this.handleChange} value={mensagem}></textarea>
                      </label>
                      {flag ?
